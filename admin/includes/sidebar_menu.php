...
<div class="left side-menu">
    ...
    <div class="left-side-logo d-block d-lg-none">
        <div class="text-center">
            <a href="index.html" class="logo"><img src="assets/images/color-logo.png" height="40" alt="logo" /></a>
        </div>
    </div>
    <!--SideBar-->
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="fab fa-cc-amazon-pay"></i><span> Categories
                        </span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i>
                        </span>
                    </a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect"><i class="mdi mdi-account"></i><span> User
                        </span><span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i>
                        </span>
                    </a>
                    <ul class="list-unstyled">
